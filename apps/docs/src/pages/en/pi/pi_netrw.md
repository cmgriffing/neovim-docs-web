...
### <a id="g:netrw_sort_options	sorting is done using [:sort](#:sort); this" class="section-title" href="#g:netrw_sort_options	sorting is done using [:sort](#:sort); this">Note:</a>
...
### <a id=" Else if there is a [:Lexplore](#:Lexplore) window in the current tab, toggle" class="section-title" href="# Else if there is a [:Lexplore](#:Lexplore) window in the current tab, toggle">Note:</a>
    its width

### <a id=" Else bring up a [:Lexplore](#:Lexplore) window" class="section-title" href="# Else bring up a [:Lexplore](#:Lexplore) window">Note:</a>
...
### <a id=" Resize the windows as you wish (see [CTRL-W_<](#CTRL-W_<) and" class="section-title" href="# Resize the windows as you wish (see [CTRL-W_<](#CTRL-W_<) and">Note:</a>
...
### <a id="\ (v:servername =~ 'GVIM\d' || v:servername == "")" class="section-title" href="#\ (v:servername =~ 'GVIM\d' || v:servername == "")">Note:</a>
		      \ [ e . ](# e . ) endif
		    augroup END
...
v171:	Oct 09, 2020	* included code in s:NetrwOptionsSafe()
				  ...
				  was zero.
### <a id=" Installed [g:netrw_clipboard](#g:netrw_clipboard) setting" class="section-title" href="# Installed [g:netrw_clipboard](#g:netrw_clipboard) setting">Note:</a>
### <a id=" Installed option bypass for ['guioptions'](#'guioptions')" class="section-title" href="# Installed option bypass for ['guioptions'](#'guioptions')">Note:</a>
				  a/A settings
...
### <a id=" Also fixed obtain ([netrw-O](#netrw-O)) to be able to" class="section-title" href="# Also fixed obtain ([netrw-O](#netrw-O)) to be able to">Note:</a>
				  obtain files with spaces in their names
### <a id="Dec 20, 2016	 (xc1427) Reported that using "I" ([netrw-I](#netrw-I))" class="section-title" href="#Dec 20, 2016	 (xc1427) Reported that using "I" ([netrw-I](#netrw-I))">Note:</a>
...
### <a id="Oct 17, 2017	 (Adam Faryna) reported that gn ([netrw-gn](#netrw-gn))" class="section-title" href="#Oct 17, 2017	 (Adam Faryna) reported that gn ([netrw-gn](#netrw-gn))">Note:</a>
...
### <a id=" [g:netrw_localrmdir](#g:netrw_localrmdir) not used any more, but" class="section-title" href="# [g:netrw_localrmdir](#g:netrw_localrmdir) not used any more, but">Note:</a>
				  the relevant patch that causes [delete()](#delete()) to
				  take over was #1107 (not #1109).
### <a id=" [expand()| is now used on |g:netrw_home](#expand()| is now used on |g:netrw_home);" class="section-title" href="# [expand()| is now used on |g:netrw_home](#expand()| is now used on |g:netrw_home);">Note:</a>
...
### <a id=" NetrwBrowse() will return line to" class="section-title" href="# NetrwBrowse() will return line to">Note:</a>
				  ...
				  banner
### <a id="Nov 16, 2015	 Added a <Plug>NetrwTreeSqueeze ([netrw-s-cr](#netrw-s-cr))" class="section-title" href="#Nov 16, 2015	 Added a <Plug>NetrwTreeSqueeze ([netrw-s-cr](#netrw-s-cr))">Note:</a>
### <a id="Nov 17, 2015	 Commented out imaps -- perhaps someone can" class="section-title" href="#Nov 17, 2015	 Commented out imaps -- perhaps someone can">Note:</a>
				  ...
				  retained?
### <a id="Nov 20, 2015	 Added [netrw-ma| and |netrw-mA](#netrw-ma| and |netrw-mA) support" class="section-title" href="#Nov 20, 2015	 Added [netrw-ma| and |netrw-mA](#netrw-ma| and |netrw-mA) support">Note:</a>
### <a id="Nov 20, 2015	 gx ([netrw-gx](#netrw-gx)) on a URL downloaded the" class="section-title" href="#Nov 20, 2015	 gx ([netrw-gx](#netrw-gx)) on a URL downloaded the">Note:</a>
				  file in addition to simply bringing up the
				  URL in a browser.  Fixed.
### <a id="Nov 23, 2015	 Added [g:netrw_sizestyle](#g:netrw_sizestyle) support" class="section-title" href="#Nov 23, 2015	 Added [g:netrw_sizestyle](#g:netrw_sizestyle) support">Note:</a>
### <a id="Nov 27, 2015	 Inserted a lot of <c-u>s into various netrw" class="section-title" href="#Nov 27, 2015	 Inserted a lot of <c-u>s into various netrw">Note:</a>
				  maps.
### <a id="Jan 05, 2016	 [netrw-qL](#netrw-qL) implemented to mark files based" class="section-title" href="#Jan 05, 2016	 [netrw-qL](#netrw-qL) implemented to mark files based">Note:</a>
...
### <a id="Jan 28, 2016	 changed to using [winsaveview()](#winsaveview()) and" class="section-title" href="#Jan 28, 2016	 changed to using [winsaveview()](#winsaveview()) and">Note:</a>
...
### <a id="Mar 28, 2015	 (requested by Matt Brooks) netrw has a lot" class="section-title" href="#Mar 28, 2015	 (requested by Matt Brooks) netrw has a lot">Note:</a>
				  ...
				  delay.
### <a id="Jun 26, 2015	 [netrw-gn](#netrw-gn) mapping implemted" class="section-title" href="#Jun 26, 2015	 [netrw-gn](#netrw-gn) mapping implemted">Note:</a>
...
### <a id="Jul 08, 2015	 Several changes to keep the [:jumps](#:jumps) table" class="section-title" href="#Jul 08, 2015	 Several changes to keep the [:jumps](#:jumps) table">Note:</a>
...
### <a id="May 16, 2014	 introduced the [netrw-ctrl-r](#netrw-ctrl-r) functionality" class="section-title" href="#May 16, 2014	 introduced the [netrw-ctrl-r](#netrw-ctrl-r) functionality">Note:</a>
### <a id="May 17, 2014	 introduced the [netrw-:NetrwMB](#netrw-:NetrwMB) functionality" class="section-title" href="#May 17, 2014	 introduced the [netrw-:NetrwMB](#netrw-:NetrwMB) functionality">Note:</a>
### <a id=" mb and mB ([netrw-mb|, |netrw-mB](#netrw-mb|, |netrw-mB)) will" class="section-title" href="# mb and mB ([netrw-mb|, |netrw-mB](#netrw-mb|, |netrw-mB)) will">Note:</a>
...
### <a id="Jun 10, 2014	 [g:netrw_gx](#g:netrw_gx) introduced to allow users to" class="section-title" href="#Jun 10, 2014	 [g:netrw_gx](#g:netrw_gx) introduced to allow users to">Note:</a>
				  override default "<cfile>" with the gx
				  ([netrw-gx](#netrw-gx)) map
### <a id="Jun 11, 2014	 gx ([netrw-gx|), with |'autowrite'](#netrw-gx|), with |'autowrite') set," class="section-title" href="#Jun 11, 2014	 gx ([netrw-gx|), with |'autowrite'](#netrw-gx|), with |'autowrite') set,">Note:</a>
...
### <a id="Jul 05, 2014	 [netrw-mv| and |netrw-mX](#netrw-mv| and |netrw-mX) commands included" class="section-title" href="#Jul 05, 2014	 [netrw-mv| and |netrw-mX](#netrw-mv| and |netrw-mX) commands included">Note:</a>
### <a id="Jul 09, 2014	 [g:netrw_keepj](#g:netrw_keepj) included, allowing optional" class="section-title" href="#Jul 09, 2014	 [g:netrw_keepj](#g:netrw_keepj) included, allowing optional">Note:</a>
				  keepj
...
### <a id="Oct 07, 2014	 gx (see [netrw-gx](#netrw-gx)) when atop a directory," class="section-title" href="#Oct 07, 2014	 gx (see [netrw-gx](#netrw-gx)) when atop a directory,">Note:</a>
...
### <a id="Dec 02, 2014	 began work on having mc ([netrw-mc](#netrw-mc)) copy" class="section-title" href="#Dec 02, 2014	 began work on having mc ([netrw-mc](#netrw-mc)) copy">Note:</a>
...
### <a id="Dec 02, 2014	 added resolved link information to" class="section-title" href="#Dec 02, 2014	 added resolved link information to">Note:</a>
				  thin and tree modes
### <a id="Dec 30, 2014	 (issue#231) [:ls](#:ls) was not showing" class="section-title" href="#Dec 30, 2014	 (issue#231) [:ls](#:ls) was not showing">Note:</a>
...
### <a id=" (Enno Nagel) turn ['rnu'](#'rnu') off in netrw" class="section-title" href="# (Enno Nagel) turn ['rnu'](#'rnu') off in netrw">Note:</a>
				  buffers.
...
### <a id="Apr 16, 2014	 sftp protocol now supported by" class="section-title" href="#Apr 16, 2014	 sftp protocol now supported by">Note:</a>
				  ...
				  files via sftp.
### <a id=" added [count]C support (see [netrw-C](#netrw-C))" class="section-title" href="# added [count]C support (see [netrw-C](#netrw-C))">Note:</a>
### <a id="Apr 18, 2014	 when [g:netrw_chgwin](#g:netrw_chgwin) is one more than" class="section-title" href="#Apr 18, 2014	 when [g:netrw_chgwin](#g:netrw_chgwin) is one more than">Note:</a>
...
### <a id=" worked on ShellCmdPost, FocusGained event" class="section-title" href="# worked on ShellCmdPost, FocusGained event">Note:</a>
				  handling.
### <a id=" [:Lexplore](#:Lexplore) path: will be used to update" class="section-title" href="# [:Lexplore](#:Lexplore) path: will be used to update">Note:</a>
				  a left-side netrw browsing directory.
### <a id="Mar 12, 2014	 [netrw-s-cr](#netrw-s-cr): use <s-cr>" class="section-title" href="#Mar 12, 2014	 [netrw-s-cr](#netrw-s-cr): use <s-cr>">Note:</a>
...
### <a id="Mar 13, 2014	 (Tony Mechylynck) reported that using" class="section-title" href="#Mar 13, 2014	 (Tony Mechylynck) reported that using">Note:</a>
				  ...
				  gzip.vim).  Fixed.
### <a id="Mar 14, 2014	 Implemented :MF and :MT (see [netrw-:MF](#netrw-:MF)" class="section-title" href="#Mar 14, 2014	 Implemented :MF and :MT (see [netrw-:MF](#netrw-:MF)">Note:</a>
				  and [netrw-:MT](#netrw-:MT), respectively)
### <a id="Mar 17, 2014	 [:Ntree](#:Ntree) [dir] wasn't working properly; fixed" class="section-title" href="#Mar 17, 2014	 [:Ntree](#:Ntree) [dir] wasn't working properly; fixed">Note:</a>
...
### <a id=" Fixed [netrw-d](#netrw-d) command when applied with ftp" class="section-title" href="# Fixed [netrw-d](#netrw-d) command when applied with ftp">Note:</a>
...
### <a id="Aug 27, 2013	 introduced [g:netrw_altfile](#g:netrw_altfile) option" class="section-title" href="#Aug 27, 2013	 introduced [g:netrw_altfile](#g:netrw_altfile) option">Note:</a>
### <a id="Sep 05, 2013	 s:Strlen() now uses [strdisplaywidth()](#strdisplaywidth())" class="section-title" href="#Sep 05, 2013	 s:Strlen() now uses [strdisplaywidth()](#strdisplaywidth())">Note:</a>
...
### <a id="Sep 12, 2013	 (Selyano Baldo) reported that netrw wasn't" class="section-title" href="#Sep 12, 2013	 (Selyano Baldo) reported that netrw wasn't">Note:</a>
				  ...
				  command line.
### <a id="Nov 09, 2013	 [:Lexplore](#:Lexplore) introduced" class="section-title" href="#Nov 09, 2013	 [:Lexplore](#:Lexplore) introduced">Note:</a>
...
### <a id=" New command installed: [:Ntree](#:Ntree)" class="section-title" href="# New command installed: [:Ntree](#:Ntree)">Note:</a>
...
### <a id="Jan 06, 2014	 Fixed a problem with [netrw-P](#netrw-P) when the" class="section-title" href="#Jan 06, 2014	 Fixed a problem with [netrw-P](#netrw-P) when the">Note:</a>
...
### <a id="May 02, 2013	 introduced [g:netrw_bannerbackslash](#g:netrw_bannerbackslash) as" class="section-title" href="#May 02, 2013	 introduced [g:netrw_bannerbackslash](#g:netrw_bannerbackslash) as">Note:</a>

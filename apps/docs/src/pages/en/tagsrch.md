...
<div class="old-help-para">You can jump to previously used tags with several commands.  Some examples:</div>
...
<div class="old-help-para">		The <code>{fieldname}</code> identifies the field, and can only contain

...
<div class="old-help-para">:fu[nction][!] <code>{name}</code>	List function <code>{name}</code>, annotated with line numbers
			unless "!" is given.
			<code>{name}</code> may be a <a href="eval.html#Dictionary">Dictionary</a> <a href="eval.html#Funcref">Funcref</a> entry:<pre>:function dict.init</pre>
...
<div class="old-help-para">			<code>{name}</code> can also be a <a href="eval.html#Dictionary">Dictionary</a> entry that is a
			<a href="eval.html#Funcref">Funcref</a>:<pre>:function dict.init(arg)</pre></div>

...
For an overview of options see [option-list](undefined#option-list).
For an overview of built-in functions see [functions](undefined#functions).
For a list of Vim variables see [vim-variable](undefined#vim-variable).
...
|i_CTRL-SHIFT-Q|  CTRL-SHIFT-Q {char}
				like CTRL-Q unless [tui-modifyOtherKeys](undefined#tui-modifyOtherKeys) is active
...
|i_CTRL-SHIFT-V|  CTRL-SHIFT-V {char}
				like CTRL-V unless [tui-modifyOtherKeys](undefined#tui-modifyOtherKeys) is active
...
commands in completion mode (see [popupmenu-keys](undefined#popupmenu-keys))
...
------------------------------------------------------------------------------ ~
		CTRL-@		   not used
[CTRL-A](undefined#CTRL-A)	CTRL-A		2  add N to number at/after cursor
[CTRL-B](undefined#CTRL-B)	CTRL-B		1  scroll N screens Backwards
[CTRL-C](undefined#CTRL-C)	CTRL-C		   interrupt current (search) command
[CTRL-D](undefined#CTRL-D)	CTRL-D		   scroll Down N lines (default: half a screen)
[CTRL-E](undefined#CTRL-E)	CTRL-E		   scroll N lines upwards (N lines Extra)
[CTRL-F](undefined#CTRL-F)	CTRL-F		1  scroll N screens Forward
[CTRL-G](undefined#CTRL-G)	CTRL-G		   display current file name and position
|<BS>|		<BS>		1  same as "h"
[CTRL-H](undefined#CTRL-H)	CTRL-H		1  same as "h"
|<Tab>|		<Tab>		1  go to N newer entry in jump list
[CTRL-I](undefined#CTRL-I)	CTRL-I		1  same as <Tab>
|<NL>|		<NL>		1  same as "j"
[CTRL-J](undefined#CTRL-J)	CTRL-J		1  same as "j"
		CTRL-K		   not used
[CTRL-L](undefined#CTRL-L)	CTRL-L		   redraw screen
|<CR>|		<CR>		1  cursor to the first CHAR N lines lower
[CTRL-M](undefined#CTRL-M)	CTRL-M		1  same as <CR>
[CTRL-N](undefined#CTRL-N)	CTRL-N		1  same as "j"
[CTRL-O](undefined#CTRL-O)	CTRL-O		1  go to N older entry in jump list
[CTRL-P](undefined#CTRL-P)	CTRL-P		1  same as "k"
		CTRL-Q		   not used, or used for terminal control flow
[CTRL-R](undefined#CTRL-R)	CTRL-R		2  redo changes which were undone with 'u'
		CTRL-S		   not used, or used for terminal control flow
[CTRL-T](undefined#CTRL-T)	CTRL-T		   jump to N older Tag in tag list
[CTRL-U](undefined#CTRL-U)	CTRL-U		   scroll N lines Upwards (default: half a
				   screen)
[CTRL-V](undefined#CTRL-V)	CTRL-V		   start blockwise Visual mode
[CTRL-W](/neovim-docs-web/en/vim/index#CTRL-W)	CTRL-W {char}	   window commands, see [CTRL-W](/neovim-docs-web/en/vim/index#CTRL-W)
[CTRL-X](undefined#CTRL-X)	CTRL-X		2  subtract N from number at/after cursor
[CTRL-Y](undefined#CTRL-Y)	CTRL-Y		   scroll N lines downwards
[CTRL-Z](undefined#CTRL-Z)	CTRL-Z		   suspend program (or start new shell)
		CTRL-[ <Esc>	   not used
...
[quote](undefined#quote)		"{register}  	   use {register} for next delete, yank or put
				   ({.%#:} only work with put)
...
### <a id="" class="section-title" href="#">[star](undefined#star)</a>
				   the ident under the cursor
|+|		+		1  same as <CR>
|,|		,		1  repeat latest f, t, F or T in opposite
				   direction N times
[-](undefined#-)		-		1  cursor to the first CHAR N lines higher
|.|		.		2  repeat last change with count replaced with
				   N
|/|		/{pattern}<CR>	1  search forward for the Nth occurrence of
				   {pattern}
|/<CR>|		/<CR>		1  search forward for {pattern} of last search
[0](undefined#0)		0		1  cursor to the first char of the line
[count](undefined#count)		1		   prepend to command to give a count
[count](undefined#count)		2			"
[count](undefined#count)		3			"
[count](undefined#count)		4			"
[count](undefined#count)		5			"
[count](undefined#count)		6			"
[count](undefined#count)		7			"
...
[A](undefined#A)		A		2  append text after the end of the line N times
[B](undefined#B)		B		1  cursor N WORDS backward
[C](undefined#C)		["x]C		2  change from the cursor position to the end
				   of the line, and N-1 more lines [into
				   register x]; synonym for "c$"
[D](undefined#D)		["x]D		2  delete the characters under the cursor
				   until the end of the line and N-1 more
				   lines [into register x]; synonym for "d$"
[E](undefined#E)		E		1  cursor forward to the end of WORD N
[F](undefined#F)		F{char}		1  cursor to the Nth occurrence of {char} to
				   the left
[G](undefined#G)		G		1  cursor to line N, default last line
[H](undefined#H)		H		1  cursor to line N from top of screen
[I](undefined#I)		I		2  insert text before the first CHAR on the
				   line N times
[J](undefined#J)		J		2  Join N lines; default is 2
[K](undefined#K)		K		   lookup Keyword under the cursor with
				   'keywordprg'
[L](undefined#L)		L		1  cursor to line N from bottom of screen
[M](undefined#M)		M		1  cursor to middle line of screen
[N](undefined#N)		N		1  repeat the latest '/' or '?' N times in
				   opposite direction
[O](undefined#O)		O		2  begin a new line above the cursor and
				   insert text, repeat N times
[P](undefined#P)		["x]P		2  put the text [from register x] before the
				   cursor N times
[R](undefined#R)		R		2  enter replace mode: overtype existing
				   characters, repeat the entered text N-1
				   times
[S](undefined#S)		["x]S		2  delete N lines [into register x] and start
				   insert; synonym for "cc".
[T](undefined#T)		T{char}		1  cursor till after Nth occurrence of {char}
				   to the left
[U](undefined#U)		U		2  undo all latest changes on one line
[V](undefined#V)		V		   start linewise Visual mode
[W](undefined#W)		W		1  cursor N WORDS forward
[X](undefined#X)		["x]X		2  delete N characters before the cursor [into
				   register x]
[Y](undefined#Y)		["x]Y		   yank N lines [into register x]; synonym for
				   "yy"
				   Note: Mapped to "y$" by default. [default-mappings](undefined#default-mappings)
[ZZ](undefined#ZZ)		ZZ		   write if buffer changed and close window
[ZQ](undefined#ZQ)		ZQ		   close window without writing
...
[a](undefined#a)		a		2  append text after the cursor N times
[b](undefined#b)		b		1  cursor N words backward
[c](undefined#c)		["x]c{motion}	2  delete Nmove text [into register x] and
				   start insert
[cc](undefined#cc)		["x]cc		2  delete N lines [into register x] and start
				   insert
[d](undefined#d)		["x]d{motion}	2  delete Nmove text [into register x]
[dd](undefined#dd)		["x]dd		2  delete N lines [into register x]
[do](undefined#do)		do		2  same as ":diffget"
[dp](undefined#dp)		dp		2  same as ":diffput"
[e](undefined#e)		e		1  cursor forward to the end of word N
[f](undefined#f)		f{char}		1  cursor to Nth occurrence of {char} to the
				   right
[g](/neovim-docs-web/en/vim/index#g)		g{char}		   extended commands, see [g](/neovim-docs-web/en/vim/index#g) below
[h](undefined#h)		h		1  cursor N chars to the left
[i](undefined#i)		i		2  insert text before the cursor N times
[j](undefined#j)		j		1  cursor N lines downward
[k](undefined#k)		k		1  cursor N lines upward
[l](undefined#l)		l		1  cursor N chars to the right
[m](undefined#m)		m{A-Za-z}	   set mark {A-Za-z} at cursor position
[n](undefined#n)		n		1  repeat the latest '/' or '?' N times
[o](undefined#o)		o		2  begin a new line below the cursor and
				   insert text, repeat N times
[p](undefined#p)		["x]p		2  put the text [from register x] after the
				   cursor N times
[q](undefined#q)		q{0-9a-zA-Z"}	   record typed characters into named register
				   {0-9a-zA-Z"} (uppercase to append)
[q](undefined#q)		q		   (while recording) stops recording
[Q](undefined#Q)		Q		   replay last recorded macro
|q:|		q:		   edit : command-line in command-line window
|q/|		q/		   edit / command-line in command-line window
|q?|		q?		   edit ? command-line in command-line window
[r](undefined#r)		r{char}		2  replace N chars with {char}
[s](undefined#s)		["x]s		2  (substitute) delete N characters [into
				   register x] and start insert
[t](undefined#t)		t{char}		1  cursor till before Nth occurrence of {char}
				   to the right
[u](undefined#u)		u		2  undo changes
[v](undefined#v)		v		   start charwise Visual mode
[w](undefined#w)		w		1  cursor N words forward
[x](undefined#x)		["x]x		2  delete N characters under and after the
				   cursor [into register x]
[y](undefined#y)		["x]y{motion}	   yank Nmove text [into register x]
[yy](undefined#yy)		["x]yy		   yank N lines [into register x]
[z](/neovim-docs-web/en/vim/index#z)		z{char}		   commands starting with 'z', see [z](/neovim-docs-web/en/vim/index#z) below
|{|		{		1  cursor N paragraphs backward
[bar](undefined#bar)		|		1  cursor to column N
...
### <a id="same as "" at the mouse click position" class="section-title" href="#same as "" at the mouse click position">|<S-LeftMouse>|	<S-LeftMouse></a>
...
### <a id="[" class="section-title" href="#[">|[star|</a>
...
|g`|		g`{mark}	1  like |`| but without changing the jumplist
### <a id="g" class="section-title" href="#g">[gstar](undefined#gstar)</a>
|g+|		g+		   go to newer text state N times
|g,|		g,		1  go to N newer position in change list
[g-](undefined#g-)		g-		   go to older text state N times
[g0](undefined#g0)		g0		1  when 'wrap' off go to leftmost character of
				   the current line that is on the screen;
				   when 'wrap' on go to the leftmost character
				   of the current screen line
[g8](undefined#g8)		g8		   print hex value of bytes used in UTF-8
...
[gD](undefined#gD)		gD		1  go to definition of word under the cursor
				   in current file
[gE](undefined#gE)		gE		1  go backwards to the end of the previous
				   WORD
[gH](undefined#gH)		gH		   start Select line mode
[gI](undefined#gI)		gI		2  like "I", but always start in column 1
[gJ](undefined#gJ)		gJ		2  join lines without inserting space
[gN](undefined#gN)		gN	      1,2  find the previous match with the last used
				   search pattern and Visually select it
[gP](undefined#gP)		["x]gP		2  put the text [from register x] before the
				   cursor N times, leave the cursor after it
[gQ](undefined#gQ)		gQ		    switch to "Ex" mode with Vim editing
[gR](undefined#gR)		gR		2  enter Virtual Replace mode
[gT](undefined#gT)		gT		   go to the previous tab page
[gU](undefined#gU)		gU{motion}	2  make Nmove text uppercase
[gV](undefined#gV)		gV		   don't reselect the previous Visual area
...
[ga](undefined#ga)		ga		   print ascii value of character under the
				   cursor
[gd](undefined#gd)		gd		1  go to definition of word under the cursor
				   in current function
[ge](undefined#ge)		ge		1  go backwards to the end of the previous
				   word
[gf](undefined#gf)		gf		   start editing the file whose name is under
				   the cursor
[gF](undefined#gF)		gF		   start editing the file whose name is under
				   the cursor and jump to the line number
				   following the filename.
[gg](undefined#gg)		gg		1  cursor to line N, default first line
[gh](undefined#gh)		gh		   start Select mode
[gi](undefined#gi)		gi		2  like "i", but first move to the |'^| mark
[gj](undefined#gj)		gj		1  like "j", but when 'wrap' on go N screen
				   lines down
[gk](undefined#gk)		gk		1  like "k", but when 'wrap' on go N screen
				   lines up
[gm](undefined#gm)		gm		1  go to character at middle of the screenline
[gM](undefined#gM)		gM		1  go to character at middle of the text line
[gn](undefined#gn)		gn	      1,2  find the next match with the last used
				   search pattern and Visually select it
[go](undefined#go)		go		1  cursor to byte N in the buffer
[gp](undefined#gp)		["x]gp		2  put the text [from register x] after the
				   cursor N times, leave the cursor after it
[gq](undefined#gq)		gq{motion}	2  format Nmove text
[gr](undefined#gr)		gr{char}	2  virtual replace N chars with {char}
[gs](undefined#gs)		gs		   go to sleep for N seconds (default 1)
[gt](undefined#gt)		gt		   go to the next tab page
[gu](undefined#gu)		gu{motion}	2  make Nmove text lowercase
[gv](undefined#gv)		gv		   reselect the previous Visual area
[gw](undefined#gw)		gw{motion}	2  format Nmove text and keep cursor
[netrw-gx](undefined#netrw-gx)	gx		   execute application for file name under the
				   cursor (only with [netrw](undefined#netrw) plugin)
...
[z-](undefined#z-)		z-		   redraw, cursor line at bottom of window,
				   cursor on first non-blank
|z.|		z.		   redraw, cursor line to center of window,
				   cursor on first non-blank
|z=|		z=		   give spelling suggestions
[zA](undefined#zA)		zA		   open a closed fold or close an open fold
				   recursively
[zC](undefined#zC)		zC		   close folds recursively
[zD](undefined#zD)		zD		   delete folds recursively
[zE](undefined#zE)		zE		   eliminate all folds
[zF](undefined#zF)		zF		   create a fold for N lines
[zG](undefined#zG)		zG		   temporarily mark word as correctly spelled
[zH](undefined#zH)		zH		   when 'wrap' off scroll half a screenwidth
				   to the right
[zL](undefined#zL)		zL		   when 'wrap' off scroll half a screenwidth
				   to the left
[zM](undefined#zM)		zM		   set 'foldlevel' to zero
[zN](undefined#zN)		zN		   set 'foldenable'
[zO](undefined#zO)		zO		   open folds recursively
[zR](undefined#zR)		zR		   set 'foldlevel' to the deepest fold
[zW](undefined#zW)		zW		   temporarily mark word as incorrectly spelled
[zX](undefined#zX)		zX		   re-apply 'foldlevel'
|z^|		z^		   cursor on line N (default line above
				   window), otherwise like "z-"
[za](undefined#za)		za		   open a closed fold, close an open fold
[zb](undefined#zb)		zb		   redraw, cursor line at bottom of window
[zc](undefined#zc)		zc		   close a fold
[zd](undefined#zd)		zd		   delete a fold
[ze](undefined#ze)		ze		   when 'wrap' off scroll horizontally to
				   position the cursor at the end (right side)
				   of the screen
[zf](undefined#zf)		zf{motion}	   create a fold for Nmove text
[zg](undefined#zg)		zg		   permanently mark word as correctly spelled
[zh](undefined#zh)		zh		   when 'wrap' off scroll screen N characters
				   to the right
[zi](undefined#zi)		zi		   toggle 'foldenable'
[zj](undefined#zj)		zj		1  move to the start of the next fold
[zk](undefined#zk)		zk		1  move to the end of the previous fold
[zl](undefined#zl)		zl		   when 'wrap' off scroll screen N characters
				   to the left
[zm](undefined#zm)		zm		   subtract one from 'foldlevel'
[zn](undefined#zn)		zn		   reset 'foldenable'
[zo](undefined#zo)		zo		   open fold
[zp](undefined#zp)		zp		   paste in block-mode without trailing spaces
[zP](undefined#zP)		zP		   paste in block-mode without trailing spaces
[zr](undefined#zr)		zr		   add one to 'foldlevel'
[zs](undefined#zs)		zs		   when 'wrap' off scroll horizontally to
				   position the cursor at the start (left
				   side) of the screen
[zt](undefined#zt)		zt		   redraw, cursor line at top of window
[zuw](undefined#zuw)		zuw		   undo [zw](undefined#zw)
[zug](undefined#zug)		zug		   undo [zg](undefined#zg)
[zuW](undefined#zuW)		zuW		   undo [zW](undefined#zW)
[zuG](undefined#zuG)		zuG		   undo [zG](undefined#zG)
[zv](undefined#zv)		zv		   open enough folds to view the cursor line
[zw](undefined#zw)		zw		   permanently mark word as incorrectly spelled
[zx](undefined#zx)		zx		   re-apply 'foldlevel' and do "zv"
[zy](undefined#zy)		zy		   yank without trailing spaces
[zz](undefined#zz)		zz		   redraw, cursor line at center of window
...
In a [terminal](undefined#terminal) buffer all keys except CTRL-\ are forwarded to the terminal
...
|:lua|		:lua		execute [Lua](undefined#Lua) command
|:luado|	:luad[o]	execute Lua command for each line
|:luafile|	:luaf[ile]	execute [Lua](undefined#Lua) script file
...
|:oldfiles|	:ol[dfiles]	list files that have marks in the [shada](undefined#shada) file
...
|:rshada|	:rsh[ada]	read from [shada](undefined#shada) file
...
|:tlmenu|	:tlm[enu]	add menu for [Terminal-mode](undefined#Terminal-mode)
|:tlnoremenu|	:tln[oremenu]	like ":noremenu" but for [Terminal-mode](undefined#Terminal-mode)
|:tlunmenu|	:tlu[nmenu]	remove menu for [Terminal-mode](undefined#Terminal-mode)
|:tmapclear|	:tmapc[lear]	remove all mappings for [Terminal-mode](undefined#Terminal-mode)
|:tmap|		:tma[p]		like ":map" but for [Terminal-mode](undefined#Terminal-mode)
|:tmenu|	:tm[enu]	define menu tooltip
|:tnext|	:tn[ext]	jump to next matching tag
|:tnoremap|	:tno[remap]	like ":noremap" but for [Terminal-mode](undefined#Terminal-mode)
|:topleft|	:to[pleft]	make split window appear at top or far left
|:tprevious|	:tp[revious]	jump to previous matching tag
|:trewind|	:tr[ewind]	jump to first matching tag
|:try|		:try		execute commands, abort on error or exception
|:tselect|	:ts[elect]	list matching tags and select one
|:tunmap|	:tunma[p]	like ":unmap" but for [Terminal-mode](undefined#Terminal-mode)

...
### <a id="ptcap.vim ft-printcap-syntax" class="section-title" href="#ptcap.vim ft-printcap-syntax">Note:</a>
...
appropriate to your system in your [myfiletypefile](undefined#myfiletypefile) file.  For these
...
```
### <a id=":au BufNewFile,BufRead /etc/termcaps/ let b:ptcap_type = "term" |" class="section-title" href="#:au BufNewFile,BufRead /etc/termcaps/ let b:ptcap_type = "term" |">Note:</a>
				       \ set filetype=ptcap
...
### <a id="progress.vim ft-progress-syntax" class="section-title" href="#progress.vim ft-progress-syntax">PROGRESS</a>
...
### <a id="python.vim ft-python-syntax" class="section-title" href="#python.vim ft-python-syntax">PYTHON</a>
...
### <a id="quake.vim ft-quake-syntax" class="section-title" href="#quake.vim ft-quake-syntax">QUAKE</a>
...
can set a different value in your [vimrc](undefined#vimrc). Example:
...
To disable syntax highlight of YAML header, add to your [vimrc](undefined#vimrc):
...
you may add this to your [vimrc](undefined#vimrc):
	let rmd_fenced_languages = ['r', 'python']


### <a id="rrst.vim ft-rrst-syntax" class="section-title" href="#rrst.vim ft-rrst-syntax">R Restructured Text</a>

To highlight R code in knitr chunk headers, add to your [vimrc](undefined#vimrc):
	let rrst_syn_hl_chunk = 1


### <a id="readline.vim ft-readline-syntax" class="section-title" href="#readline.vim ft-readline-syntax">READLINE</a>

The readline library is primarily used by the BASH shell, which adds quite a
few commands and options to the ones already available.  To highlight these
items as well you can add the following to your [vimrc](undefined#vimrc) or just type it in the
...
### <a id="rego.vim ft-rego-syntax" class="section-title" href="#rego.vim ft-rego-syntax">REGO</a>
...
### <a id="rst.vim ft-rst-syntax" class="section-title" href="#rst.vim ft-rst-syntax">Restructured Text</a>
...
### <a id="rexx.vim ft-rexx-syntax" class="section-title" href="#rexx.vim ft-rexx-syntax">REXX</a>
...
### <a id="g:filetype_r" class="section-title" href="#g:filetype_r">your vimrc:</a>
	:let g:filetype_r = "r"
...
### <a id="ruby_space_errors" class="section-title" href="#ruby_space_errors">Note:</a>
...
### <a id="ruby_fold ruby_foldable_groups" class="section-title" href="#ruby_fold ruby_foldable_groups">Note:</a>
 Ruby: Folding ~
...
### <a id="ruby_no_expensive" class="section-title" href="#ruby_no_expensive">Note:</a>
...
### <a id="ruby_minlines" class="section-title" href="#ruby_minlines">Note:</a>
...
### <a id="ruby_spellcheck_strings" class="section-title" href="#ruby_spellcheck_strings">Note:</a>
...
### <a id="scheme.vim ft-scheme-syntax" class="section-title" href="#scheme.vim ft-scheme-syntax">SCHEME</a>
...
### <a id="sdl.vim ft-sdl-syntax" class="section-title" href="#sdl.vim ft-sdl-syntax">SDL</a>
...
### <a id="sed.vim ft-sed-syntax" class="section-title" href="#sed.vim ft-sed-syntax">SED</a>
...
### <a id="sgml.vim ft-sgml-syntax" class="section-title" href="#sgml.vim ft-sgml-syntax">SGML</a>
...
### <a id="ft-posix-syntax ft-dash-syntax" class="section-title" href="#ft-posix-syntax ft-dash-syntax">Note:</a>
### <a id="sh.vim" class="section-title" href="#sh.vim">SH</a>
...
### <a id="ksh : .kshrc .ksh" class="section-title" href="#ksh : .kshrc .ksh">Note:</a>
### <a id="bash: .bashrc bashrc bash.bashrc .bash_profile .bash" class="section-title" href="#bash: .bashrc bashrc bash.bashrc .bash_profile .bash">Note:</a>
```
...
### <a id="sh-embed" class="section-title" href="#sh-embed">Note:</a>
...
### <a id="spup.vim ft-spup-syntax" class="section-title" href="#spup.vim ft-spup-syntax">SPEEDUP</a>
...
### <a id="sql.vim ft-sql-syntax" class="section-title" href="#sql.vim ft-sql-syntax">SQL</a>
### <a id="sqlinformix.vim ft-sqlinformix-syntax" class="section-title" href="#sqlinformix.vim ft-sqlinformix-syntax">Note:</a>
### <a id="sqlanywhere.vim ft-sqlanywhere-syntax" class="section-title" href="#sqlanywhere.vim ft-sqlanywhere-syntax">Note:</a>
...
### <a id="Vim assumes ".sql" files are Oracle SQL by default." class="section-title" href="#Vim assumes ".sql" files are Oracle SQL by default.">Sql.</a>
...
### <a id="tex.vim ft-tex-syntax latex-syntax" class="section-title" href="#tex.vim ft-tex-syntax latex-syntax">TEX</a>
### <a id="syntax-tex syntax-latex" class="section-title" href="#syntax-tex syntax-latex">Note:</a>

			Tex Contents~
	Tex: Want Syntax Folding?			[tex-folding](undefined#tex-folding)
	Tex: No Spell Checking Wanted			|g:tex_nospell|
	Tex: Don't Want Spell Checking In Comments?	[tex-nospell](undefined#tex-nospell)
	Tex: Want Spell Checking in Verbatim Zones?	[tex-verb](undefined#tex-verb)
	Tex: Run-on Comments or MathZones		[tex-runon](undefined#tex-runon)
	Tex: Slow Syntax Highlighting?			[tex-slow](undefined#tex-slow)
	Tex: Want To Highlight More Commands?		[tex-morecommands](undefined#tex-morecommands)
	Tex: Excessive Error Highlighting?		[tex-error](undefined#tex-error)
	Tex: Need a new Math Group?			[tex-math](undefined#tex-math)
	Tex: Starting a New Style?			[tex-style](undefined#tex-style)
	Tex: Taking Advantage of Conceal Mode		[tex-conceal](undefined#tex-conceal)
	Tex: Selective Conceal Mode			|g:tex_conceal|
	Tex: Controlling iskeyword			|g:tex_isk|
	Tex: Fine Subscript and Superscript Control	[tex-supersub](undefined#tex-supersub)
	Tex: Match Check Control			[tex-matchcheck](undefined#tex-matchcheck)
...
### <a id="g:tex_nospell" class="section-title" href="#g:tex_nospell">Note:</a>
...
### <a id="tex-runon tex-stopzone" class="section-title" href="#tex-runon tex-stopzone">Note:</a>
...
### <a id="tex-slow tex-sync" class="section-title" href="#tex-slow tex-sync">Note:</a>
...
[tex-folding](undefined#tex-folding) for a way around this.
...
(also see: |g:tex_conceal| and [tex-supersub](undefined#tex-supersub))
...
techniques in [mysyntaxfile-add](undefined#mysyntaxfile-add) to extend or modify the highlighting provided
by syntax/tex.vim.
...
### <a id="tex-error g:tex_no_error" class="section-title" href="#tex-error g:tex_no_error">Note:</a>
...
### <a id="tex-math" class="section-title" href="#tex-math">Note:</a>
...
### <a id="tex-style b:tex_stylish" class="section-title" href="#tex-style b:tex_stylish">Note:</a>
 Tex: Starting a New Style? ~

One may use "\makeatletter" in *.tex files, thereby making the use of "@" in
### <a id="However, since the .tex file doesn't have one of the" class="section-title" href="#However, since the .tex file doesn't have one of the">commands available.</a>
...
### <a id="g:tex_isk g:tex_stylish" class="section-title" href="#g:tex_isk g:tex_stylish">Note:</a>
...
### <a id="tex-supersub g:tex_superscripts g:tex_subscripts" class="section-title" href="#tex-supersub g:tex_superscripts g:tex_subscripts">Note:</a>
 Tex: Fine Subscript and Superscript Control~
	...
	See [tex-conceal](undefined#tex-conceal) for how to enable concealed character replacement.
...
### <a id="tex-matchcheck g:tex_matchcheck" class="section-title" href="#tex-matchcheck g:tex_matchcheck">Note:</a>
...
### <a id="tf.vim ft-tf-syntax" class="section-title" href="#tf.vim ft-tf-syntax">TF</a>
...
### <a id="vim.vim" class="section-title" href="#vim.vim">VIM</a>
### <a id="g:vimsyn_minlines	g:vimsyn_maxlines" class="section-title" href="#g:vimsyn_minlines	g:vimsyn_maxlines">Note:</a>
...
### <a id="g:vimsyn_embed" class="section-title" href="#g:vimsyn_embed">Note:</a>
...
### <a id="g:vimsyn_folding" class="section-title" href="#g:vimsyn_folding">Note:</a>
...
highlighting is to put the following line in your [vimrc](undefined#vimrc):
```
...
### <a id="xf86conf.vim ft-xf86conf-syntax" class="section-title" href="#xf86conf.vim ft-xf86conf-syntax">XF86CONFIG</a>
...
### <a id="xml.vim ft-xml-syntax" class="section-title" href="#xml.vim ft-xml-syntax">XML</a>
...
The xml syntax file provides syntax [folding](undefined#folding) (see |:syn-fold|) between
...
### <a id="xpm.vim ft-xpm-syntax" class="section-title" href="#xpm.vim ft-xpm-syntax">X Pixmaps (XPM)</a>
...
### <a id="yaml.vim ft-yaml-syntax" class="section-title" href="#yaml.vim ft-yaml-syntax">YAML</a>

### <a id="g:yaml_schema b:yaml_schema" class="section-title" href="#g:yaml_schema b:yaml_schema">Note:</a>
...
### <a id="zsh.vim ft-zsh-syntax" class="section-title" href="#zsh.vim ft-zsh-syntax">ZSH</a>
...
## <a id=":syn-define E410" class="section-title" href="#:syn-define E410">6. Defining a Syntax</a> 
...
### <a id=":syn-priority" class="section-title" href="#:syn-priority">PRIORITY</a>
...
### <a id=":syn-case E390" class="section-title" href="#:syn-case E390">Defining Case</a>
...
### <a id=":syn-foldlevel" class="section-title" href="#:syn-foldlevel">Defining Foldlevel</a>

:sy[ntax] foldlevel start
:sy[ntax] foldlevel minimum
	This defines how the foldlevel of a line is computed when using
	foldmethod=syntax (see [fold-syntax](undefined#fold-syntax) and |:syn-fold|):
...
### <a id=":syn-spell" class="section-title" href="#:syn-spell">Spell Checking</a>
...
:sy[ntax] spell default
	...
	[spell-syntax](undefined#spell-syntax).  When there is no @Spell and no @NoSpell cluster then
...
### <a id=":syn-iskeyword" class="section-title" href="#:syn-iskeyword">Syntax Iskeyword Setting</a>
...
### <a id=":syn-keyword" class="section-title" href="#:syn-keyword">Defining Keywords</a>
...
### <a id="E789 E890" class="section-title" href="#E789 E890">Note:</a>
...
### <a id=":syn-match" class="section-title" href="#:syn-match">Defining Matches</a>
...
### <a id="E398 E399" class="section-title" href="#E398 E399">Note:</a>
...
### <a id=":syn-keepend" class="section-title" href="#:syn-keepend">Note:</a>
  ...
  :syn region vimCommand start="set" end="$" contains=vimComment keepend
	...
	contained matches.
### <a id=":syn-extend" class="section-title" href="#:syn-extend">Note:</a>
...
### <a id=":syn match htmlItem +<[^>]>+ contained" class="section-title" href="#:syn match htmlItem +<[^>]>+ contained">Note:</a>
### <a id=":syn region htmlScript start=+<script+ end=+</script[^>]>+ contained extend" class="section-title" href="#:syn region htmlScript start=+<script+ end=+</script[^>]>+ contained extend">Note:</a>
...
### <a id=":syn-excludenl" class="section-title" href="#:syn-excludenl">Note:</a>
...
### <a id=":syn-matchgroup" class="section-title" href="#:syn-matchgroup">Note:</a>
...
### <a id="E849" class="section-title" href="#E849">Note:</a>
The maximum number of syntax groups is 19999.


## <a id=":syn-arguments" class="section-title" href="#:syn-arguments">7. :Syntax Arguments</a> 
...
### <a id="E395" class="section-title" href="#E395">Note:</a>
...
### <a id="conceal :syn-conceal" class="section-title" href="#conceal :syn-conceal">conceal</a>
...
### <a id=":syn-cchar" class="section-title" href="#:syn-cchar">cchar</a>
### <a id="E844" class="section-title" href="#E844">Note:</a>
...
See [hl-Conceal](undefined#hl-Conceal) for highlighting.
...
### <a id=":syn-display" class="section-title" href="#:syn-display">display</a>
...
### <a id="for a "/" comment can't contain "display", because it continues on the next" class="section-title" href="#for a "/" comment can't contain "display", because it continues on the next">Note:</a>
  line.
...
### <a id=""//" comment can't use "display", because a "/" inside that comment would" class="section-title" href="#"//" comment can't use "display", because a "/" inside that comment would">Note:</a>
...
### <a id=":syn-transparent" class="section-title" href="#:syn-transparent">transparent</a>
...
### <a id="/\<[a-z]\>/ contained" class="section-title" href="#/\<[a-z]\>/ contained">	:syn match myWord</a>
...
### <a id=":syn-oneline" class="section-title" href="#:syn-oneline">oneline</a>
...
### <a id=":syn-fold" class="section-title" href="#:syn-fold">fold</a>
...
### <a id=":syn-contains E405 E406 E407 E408 E409" class="section-title" href="#:syn-contains E405 E406 E407 E408 E409">Note:</a>
contains={group-name},..
...
### <a id="... contains=Comment.,Keyw[0-3]" class="section-title" href="#... contains=Comment.,Keyw[0-3]">Note:</a>
...
### <a id=":syn-containedin" class="section-title" href="#:syn-containedin">containedin={group-name}...</a>
...
### <a id=":syn-nextgroup" class="section-title" href="#:syn-nextgroup">nextgroup={group-name},..</a>
...
would include the first "Foo" and the last "Bar" in the line (see [pattern](undefined#pattern)).


### <a id=":syn-skipwhite" class="section-title" href="#:syn-skipwhite">skipwhite</a>
### <a id=":syn-skipnl" class="section-title" href="#:syn-skipnl">skipnl</a>
### <a id=":syn-skipempty" class="section-title" href="#:syn-skipempty">skipempty</a>
...
Example:
### <a id=":syn match ifstart "\<if."" class="section-title" href="#:syn match ifstart "\<if."">Note:</a>
...
### <a id=":syn-conceal-implicit" class="section-title" href="#:syn-conceal-implicit">Implicit Conceal</a>
...
## <a id=":syn-pattern E401 E402" class="section-title" href="#:syn-pattern E401 E402">8. Syntax Patterns</a> 
...
See [pattern](undefined#pattern) for the explanation of what a pattern is.  Syntax patterns are
...
### <a id=":syn-pattern-offset" class="section-title" href="#:syn-pattern-offset">Note:</a>
...
#### <a id=":syntax region Comment start="/\"hs=e+1 end="\/"he=s-1" class="section-title" href="#:syntax region Comment start="/\"hs=e+1 end="\/"he=s-1">```</a>
```
...
### <a id=":syn-multi-line" class="section-title" href="#:syn-multi-line">Multi-line patterns</a>
...
### <a id=":syn-ext-match" class="section-title" href="#:syn-ext-match">External matches</a>

These extra regular expression items are available in region patterns:

### <a id="/\z( /\z(\) E50 E52 E879" class="section-title" href="#/\z( /\z(\) E50 E52 E879">Note:</a>
...
### <a id="/\z1 /\z2 /\z3 /\z4 /\z5" class="section-title" href="#/\z1 /\z2 /\z3 /\z4 /\z5">Note:</a>
...
### <a id=":syn region hereDoc start="<<\z(\I\i\)" end="^\z1$"" class="section-title" href="#:syn region hereDoc start="<<\z(\I\i\)" end="^\z1$"">Note:</a>
...
### <a id=":syn region foo start="start \z(\I\i\)" skip="not end \z1" end="end \z1"" class="section-title" href="#:syn region foo start="start \z(\I\i\)" skip="not end \z1" end="end \z1"">Note:</a>
...
## <a id=":syn-cluster E400" class="section-title" href="#:syn-cluster E400">9. Syntax Clusters</a> 
...
### <a id="E848" class="section-title" href="#E848">Note:</a>
The maximum number of clusters is 9767.


## <a id=":syn-include E397" class="section-title" href="#:syn-include E397">10. Including Syntax Files</a> 
...
### <a id="E847" class="section-title" href="#E847">Note:</a>
The maximum number of includes is 999.


## <a id=":syn-sync E403 E404" class="section-title" href="#:syn-sync E403 E404">11. Synchronizing</a> 
...
### <a id=":syn-sync-linebreaks" class="section-title" href="#:syn-sync-linebreaks">Note:</a>
...
### <a id=":syn-sync-first" class="section-title" href="#:syn-sync-first">First syncing method:</a>
...
### <a id=":syn-sync-second :syn-sync-ccomment" class="section-title" href="#:syn-sync-second :syn-sync-ccomment">Second syncing method:</a>
...
### <a id=":syn-sync-third" class="section-title" href="#:syn-sync-third">Third syncing method:</a>
...
### <a id=":syn-sync-fourth" class="section-title" href="#:syn-sync-fourth">Fourth syncing method:</a>
...
### <a id="(e.g., in a C-comment like / this /, the last "/" is used)." class="section-title" href="#(e.g., in a C-comment like / this /, the last "/" is used).">Note:</a>
...
### <a id="syn-sync-grouphere E393 E394" class="section-title" href="#syn-sync-grouphere E393 E394">Note:</a>
...
### <a id="syn-sync-groupthere" class="section-title" href="#syn-sync-groupthere">Note:</a>
...
### <a id="If "/" is found first, you know that you" class="section-title" href="#If "/" is found first, you know that you">	"groupthere" is "cComment".</a>
...
### <a id="syn-sync-linecont" class="section-title" href="#syn-sync-linecont">Note:</a>
...
## <a id=":syntax :sy :syn :syn-list" class="section-title" href="#:syntax :sy :syn :syn-list">12. Listing Syntax Items</a> 
...
### <a id="E392" class="section-title" href="#E392">To list the syntax groups in one cluster:</a>
...
- The built-in [highlight-groups](undefined#highlight-groups).
- The ones used for specific languages.  For these the name starts with the
  name of the language.  Many of these don't have any attributes, but are
  linked to a group of the second type.
### <a id="hitest.vim" class="section-title" href="#hitest.vim">Note:</a>
You can see all the groups currently active with this command:
```    :so $VIMRUNTIME/syntax/hitest.vim
This will open a new window containing all highlight group names, displayed
in their own color.

### <a id=":colo :colorscheme E185" class="section-title" href="#:colo :colorscheme E185">Note:</a>
...
:colo[rscheme] {name}	Load color scheme {name}.  This searches 'runtimepath'
			...
			[ColorSchemePre](undefined#ColorSchemePre) autocommand event is triggered.
			After the color scheme has been loaded the
			[ColorScheme](undefined#ColorScheme) autocommand event is triggered.
...
### <a id="highlight-clear :hi-clear" class="section-title" href="#highlight-clear :hi-clear">Note:</a>
...
:hi[ghlight] [default] {group-name} {key}={arg} ..
			...
			an existing group.
			See [highlight-args](undefined#highlight-args) for the {key}={arg} arguments.
...
### <a id=":highlight-verbose" class="section-title" href="#:highlight-verbose">Note:</a>
...
cterm	terminal UI ([TUI](undefined#TUI))
...
### <a id="bold underline undercurl" class="section-title" href="#bold underline undercurl">Note:</a>
### <a id="underdouble underdotted" class="section-title" href="#underdouble underdotted">Note:</a>
### <a id="underdashed inverse italic" class="section-title" href="#underdashed inverse italic">Note:</a>
### <a id="standout nocombine strikethrough" class="section-title" href="#standout nocombine strikethrough">Note:</a>
### <a id="attr-list highlight-cterm E418" class="section-title" href="#attr-list highlight-cterm E418">cterm={attr-list}</a>
	...
	set using [guisp](undefined#guisp).
...
### <a id="ctermbg" class="section-title" href="#ctermbg">ctermbg={color-nr}</a>
	...
	(not including) the number of [tui-colors](undefined#tui-colors) available.
...
### <a id="cterm-colors" class="section-title" href="#cterm-colors">Note:</a>
...
### <a id="The '' indicates that the" class="section-title" href="#The '' indicates that the">	8-color terminals ('t_Co' less than 16).</a>
...
### <a id="Here '' means 'add 8' so that " class="section-title" href="#Here '' means 'add 8' so that ">	numbers in the NR-8 column is used.</a>
...
### <a id=":hi-normal-cterm" class="section-title" href="#:hi-normal-cterm">Note:</a>
	...
	"orig_pair" [terminfo](undefined#terminfo) entry.
...
### <a id="highlight-gui" class="section-title" href="#highlight-gui">gui={attr-list}</a>
	...
	See [attr-list](undefined#attr-list) for a description.
	Note that "bold" can be used here and by using a bold font.  They
	have the same effect.
	Note that the attributes are ignored for the "Normal" group.

### <a id="highlight-font" class="section-title" href="#highlight-font">font={font-name}</a>
...
### <a id="guifg" class="section-title" href="#guifg">guifg={color-name}</a>
### <a id="guibg" class="section-title" href="#guibg">guibg={color-name}</a>
### <a id="guisp" class="section-title" href="#guisp">guisp={color-name}</a>
...
### <a id="gui-colors" class="section-title" href="#gui-colors">Note:</a>
...
### <a id="highlight-blend" class="section-title" href="#highlight-blend">blend={integer}</a>
...
### <a id="highlight-groups highlight-default" class="section-title" href="#highlight-groups highlight-default">Note:</a>
...
":highlight" command.
### <a id="hl-ColorColumn" class="section-title" href="#hl-ColorColumn">Note:</a>
ColorColumn	Used for the columns set with 'colorcolumn'.
### <a id="hl-Conceal" class="section-title" href="#hl-Conceal">Note:</a>
Conceal		Placeholder characters substituted for concealed
		text (see 'conceallevel').
### <a id="hl-CurSearch" class="section-title" href="#hl-CurSearch">Note:</a>
...
lCursor		Character under the cursor when [language-mapping](undefined#language-mapping)
		is used (see 'guicursor').
### <a id="hl-CursorIM" class="section-title" href="#hl-CursorIM">Note:</a>
CursorIM	Like Cursor, but used when in IME mode. *CursorIM*
### <a id="hl-CursorColumn" class="section-title" href="#hl-CursorColumn">Note:</a>
CursorColumn	Screen-column at the cursor, when 'cursorcolumn' is set.
### <a id="hl-CursorLine" class="section-title" href="#hl-CursorLine">Note:</a>
...
EndOfBuffer	Filler lines (~) after the end of the buffer.
		By default, this is highlighted like [hl-NonText](undefined#hl-NonText).
...
### <a id="hl-ErrorMsg" class="section-title" href="#hl-ErrorMsg">Note:</a>
ErrorMsg	Error messages on the command line.
### <a id="hl-WinSeparator" class="section-title" href="#hl-WinSeparator">Note:</a>
WinSeparator	Separators between window splits.
### <a id="hl-Folded" class="section-title" href="#hl-Folded">Note:</a>
...
SignColumn	Column where [signs](undefined#signs) are displayed.
...
### <a id="hl-LineNrAbove" class="section-title" href="#hl-LineNrAbove">Note:</a>
LineNrAbove	Line number for when the 'relativenumber'
		option is set, above the cursor line.
### <a id="hl-LineNrBelow" class="section-title" href="#hl-LineNrBelow">Note:</a>
LineNrBelow	Line number for when the 'relativenumber'
		option is set, below the cursor line.
### <a id="hl-CursorLineNr" class="section-title" href="#hl-CursorLineNr">Note:</a>
CursorLineNr	Like LineNr when 'cursorline' is set and 'cursorlineopt'
		contains "number" or is "both", for the cursor line.
### <a id="hl-CursorLineSign" class="section-title" href="#hl-CursorLineSign">Note:</a>
CursorLineSign	Like SignColumn when 'cursorline' is set for the cursor line.
### <a id="hl-CursorLineFold" class="section-title" href="#hl-CursorLineFold">Note:</a>
...
MsgSeparator	Separator for scrolled messages [msgsep](undefined#msgsep).
### <a id="hl-MoreMsg" class="section-title" href="#hl-MoreMsg">Note:</a>
MoreMsg		[more-prompt](undefined#more-prompt)
### <a id="hl-NonText" class="section-title" href="#hl-NonText">Note:</a>
NonText		'@' at the end of the window, characters from 'showbreak'
		and other characters that do not really exist in the text
		(e.g., ">" displayed when a double-wide character doesn't
		fit at the end of the line). See also [hl-EndOfBuffer](undefined#hl-EndOfBuffer).
...
### <a id="hl-NormalNC" class="section-title" href="#hl-NormalNC">Note:</a>
NormalNC	Normal text in non-current windows.
### <a id="hl-Pmenu" class="section-title" href="#hl-Pmenu">Note:</a>
Pmenu		Popup menu: Normal item.
### <a id="hl-PmenuSel" class="section-title" href="#hl-PmenuSel">Note:</a>
PmenuSel	Popup menu: Selected item.
### <a id="hl-PmenuSbar" class="section-title" href="#hl-PmenuSbar">Note:</a>
...
Question	[hit-enter](undefined#hit-enter) prompt and yes/no questions.
### <a id="hl-QuickFixLine" class="section-title" href="#hl-QuickFixLine">Note:</a>
QuickFixLine	Current [quickfix](undefined#quickfix) item in the quickfix window. Combined with
                [hl-CursorLine](undefined#hl-CursorLine) when the cursor is there.
...
SpecialKey	Unprintable characters: Text displayed differently from what
		it really is. But not 'listchars' whitespace. [hl-Whitespace](undefined#hl-Whitespace)
### <a id="hl-SpellBad" class="section-title" href="#hl-SpellBad">Note:</a>
SpellBad	Word that is not recognized by the spellchecker. [spell](undefined#spell)
		Combined with the highlighting used otherwise.
### <a id="hl-SpellCap" class="section-title" href="#hl-SpellCap">Note:</a>
SpellCap	Word that should start with a capital. [spell](undefined#spell)
		Combined with the highlighting used otherwise.
### <a id="hl-SpellLocal" class="section-title" href="#hl-SpellLocal">Note:</a>
SpellLocal	Word that is recognized by the spellchecker as one that is
		used in another region. [spell](undefined#spell)
		Combined with the highlighting used otherwise.
### <a id="hl-SpellRare" class="section-title" href="#hl-SpellRare">Note:</a>
SpellRare	Word that is recognized by the spellchecker as one that is
		hardly ever used. [spell](undefined#spell)
		Combined with the highlighting used otherwise.
### <a id="hl-StatusLine" class="section-title" href="#hl-StatusLine">Note:</a>
StatusLine	Status line of current window.
### <a id="hl-StatusLineNC" class="section-title" href="#hl-StatusLineNC">Note:</a>
StatusLineNC	Status lines of not-current windows.
		Note: If this is equal to "StatusLine", Vim will use "^^^" in
		the status line of the current window.
### <a id="hl-TabLine" class="section-title" href="#hl-TabLine">Note:</a>
TabLine		Tab pages line, not active tab page label.
### <a id="hl-TabLineFill" class="section-title" href="#hl-TabLineFill">Note:</a>
TabLineFill	Tab pages line, where there are no labels.
### <a id="hl-TabLineSel" class="section-title" href="#hl-TabLineSel">Note:</a>
TabLineSel	Tab pages line, active tab page label.
### <a id="hl-Title" class="section-title" href="#hl-Title">Note:</a>
Title		Titles for output from ":set all", ":autocmd" etc.
### <a id="hl-Visual" class="section-title" href="#hl-Visual">Note:</a>
Visual		Visual mode selection.
### <a id="hl-VisualNOS" class="section-title" href="#hl-VisualNOS">Note:</a>
VisualNOS	Visual mode selection when vim is "Not Owning the Selection".
### <a id="hl-WarningMsg" class="section-title" href="#hl-WarningMsg">Note:</a>
WarningMsg	Warning messages.
### <a id="hl-Whitespace" class="section-title" href="#hl-Whitespace">Note:</a>
Whitespace	"nbsp", "space", "tab", "multispace", "lead" and "trail"
		in 'listchars'.
### <a id="hl-WildMenu" class="section-title" href="#hl-WildMenu">Note:</a>
WildMenu	Current match in 'wildmenu' completion.
### <a id="hl-WinBar" class="section-title" href="#hl-WinBar">Note:</a>
WinBar		Window bar of current window.
### <a id="hl-WinBarNC" class="section-title" href="#hl-WinBarNC">Note:</a>
WinBarNC	Window bar of not-current windows.

### <a id="hl-User1 hl-User1..9 hl-User9" class="section-title" href="#hl-User1 hl-User1..9 hl-User9">Note:</a>
...
### <a id="hl-Menu" class="section-title" href="#hl-Menu">Note:</a>
Menu		Current font, background and foreground colors of the menus.
		Also used for the toolbar.
		Applicable highlight arguments: font, guibg, guifg.

### <a id="hl-Scrollbar" class="section-title" href="#hl-Scrollbar">Note:</a>
Scrollbar	Current background and foreground of the main window's
		scrollbars.
		Applicable highlight arguments: guibg, guifg.

### <a id="hl-Tooltip" class="section-title" href="#hl-Tooltip">Note:</a>
Tooltip		Current font, background and foreground of the tooltips.
		Applicable highlight arguments: font, guibg, guifg.


## <a id=":hi-link :highlight-link E412 E413" class="section-title" href="#:hi-link :highlight-link E412 E413">13. Linking Groups</a> 
...
### <a id="E414" class="section-title" href="#E414">Notes:</a>
...
### <a id=":hi-default :highlight-default" class="section-title" href="#:hi-default :highlight-default">Note:</a>
...
## <a id=":syn-clear E391" class="section-title" href="#:syn-clear E391">15. Cleaning Up</a> 
...
### <a id=":syntax-off :syn-off" class="section-title" href="#:syntax-off :syn-off">Note:</a>
...
### <a id="autocmd BufRead,BufNewFile .[ch] let fname = expand('<afile>:p:h') .. '/types.vim'" class="section-title" href="#autocmd BufRead,BufNewFile .[ch] let fname = expand('<afile>:p:h') .. '/types.vim'">Note:</a>
### <a id="autocmd BufRead,BufNewFile .[ch] if filereadable(fname)" class="section-title" href="#autocmd BufRead,BufNewFile .[ch] if filereadable(fname)">Note:</a>
### <a id="autocmd BufRead,BufNewFile .[ch]" class="section-title" href="#autocmd BufRead,BufNewFile .[ch]">Note:</a>
### <a id="autocmd BufRead,BufNewFile .[ch] endif" class="section-title" href="#autocmd BufRead,BufNewFile .[ch] endif">Note:</a>


## <a id=":ownsyntax" class="section-title" href="#:ownsyntax">17. Window-Local Syntax</a> 
...
windows on the buffer:
   :ownsyntax foo
### <a id="w:current_syntax" class="section-title" href="#w:current_syntax">Note:</a>
...
## <a id="xterm-color color-xterm" class="section-title" href="#xterm-color color-xterm">17. Color Xterms</a> 

### <a id="colortest.vim" class="section-title" href="#colortest.vim">Note:</a>
To test your color setup, a file has been included in the Vim distribution.
To use it, execute this command:
   :runtime syntax/colortest.vim

Nvim uses 256-color and [true-color](undefined#true-color) terminal capabilities wherever possible.
...
as 'relativenumber' and [folding](undefined#folding).

...
1. Testing Vim				[testing](/neovim-docs-web/en/vim/testing#testing)
2. Test functions			[test-functions-details](/neovim-docs-web/en/vim/testing#test-functions-details)
3. Assert functions			[assert-functions-details](/neovim-docs-web/en/vim/testing#assert-functions-details)
...
### <a id="assert_beeps()" class="section-title" href="#assert_beeps()">assert_beeps({cmd})</a>
		...
		[assert-return](undefined#assert-return).
...
assert_equal({expected}, {actual} [, {msg}])
		...
		returned [assert-return](undefined#assert-return).
...
assert_equalfile({fname-one}, {fname-two})
		...
		Also see [assert-return](undefined#assert-return).
...
### <a id="assert_exception()" class="section-title" href="#assert_exception()">assert_exception({error} [, {msg}])</a>
		...
		message is added to |v:errors|.  Also see [assert-return](undefined#assert-return).
...
### <a id="assert_fails()" class="section-title" href="#assert_fails()">assert_fails({cmd} [, {error} [, {msg}]])</a>
		Run {cmd} and add an error message to |v:errors| if it does
		NOT produce an error.  Also see [assert-return](undefined#assert-return).
...
### <a id="assert_inrange()" class="section-title" href="#assert_inrange()">assert_inrange({lower}, {upper}, {actual} [, {msg}])</a>
		This asserts number and [Float](undefined#Float) values.  When {actual}  is lower
		than {lower} or higher than {upper} an error message is added
		to |v:errors|.  Also see [assert-return](undefined#assert-return).
		When {msg} is omitted an error in the form
...
assert_match({pattern}, {actual} [, {msg}])
		...
		added to |v:errors|.  Also see [assert-return](undefined#assert-return).
...
### <a id="assert_true()" class="section-title" href="#assert_true()">assert_true({actual} [, {msg}])</a>
		...
		|v:errors|, like with |assert_equal()|.
		Also see [assert-return](undefined#assert-return).
		A value is [TRUE](undefined#TRUE) when it is a non-zero number or |v:true|.

...
<div class="old-help-para">This is introduced in section <a href="usr_04.html#04.4">04.4</a> of the user manual.</div>
...
<div class="old-help-para">The <a href="syntax.html#hl-Visual">hl-Visual</a> group determines the highlighting of the visual selection.
...
However, when the <a href="options.html#'selection'">'selection'</a> option is set to "exclusive" and the cursor is
...
[count]v		Start Visual mode per character.
			...
			<a href="options.html#'selection'">'selection'</a> is not "exclusive".</div>
...
started <a href="starting.html#CTRL-Z">CTRL-Z</a>.</div>
...
<div class="old-help-para">								<a name="gN"></a><code class="help-tag-right">gN</code> <a name="v_gN"></a><code class="help-tag">v_gN</code>
gN			Like <a href="visual.html#gn">gn</a> but searches backward, like with <code>N</code>.</div>
...
<code>&lt;LeftMouse&gt;</code>		Set the current cursor position.  If Visual mode is
			active it is stopped.  Only when <a href="options.html#'mouse'">'mouse'</a> option
			contains 'n' or 'a'.  If the position is within <a href="options.html#'so'">'so'</a>
...
<code>&lt;RightMouse&gt;</code>		Start Visual mode if it is not active.  The text from
			...
			<a href="options.html#'mouse'">'mouse'</a> option contains 'n' or 'a'.</div>
<div class="old-help-para">			Note: when <a href="options.html#'mousemodel'">'mousemodel'</a> is set to "popup",
...
<code>&lt;LeftRelease&gt;</code>		This works like a <code>&lt;LeftMouse&gt;</code>, if it is not at
			...
			when <a href="options.html#'mouse'">'mouse'</a> option contains 'n' or 'a'.</div>
...
"gv" <a href="visual.html#gv">gv</a> <a href="visual.html#v_gv">v_gv</a>.</div>
...
<a href="options.html#'mousemodel'">'mousemodel'</a> is "popup") to drag either end of the Visual area.</div>
...
<div class="old-help-para">The operators that can be used are:
	~	switch case					<a href="change.html#v_~">v_~</a>
	...
	!	filter through external command (1)		<a href="change.html#v_%21">v_!</a>
	=	filter through <a href="options.html#'equalprg'">'equalprg'</a> option command (1)	<a href="change.html#v_%3D">v_=</a>
	gq	format lines to <a href="options.html#'textwidth'">'textwidth'</a> length (1)		<a href="change.html#v_gq">v_gq</a></div>
<div class="old-help-para">The objects that can be used are:
	...
	ab	a () block (with parentheses)			<a href="motion.html#v_ab">v_ab</a>
	ib	inner () block					<a href="motion.html#v_ib">v_ib</a>
	aB	a {} block (with braces)			<a href="motion.html#v_aB">v_aB</a>
	iB	inner {} block					<a href="motion.html#v_iB">v_iB</a>
	at	a <code>&lt;tag&gt;</code> &lt;/tag&gt; block (with tags)		<a href="motion.html#v_at">v_at</a>
	it	inner <code>&lt;tag&gt;</code> &lt;/tag&gt; block			<a href="motion.html#v_it">v_it</a>
	a&lt;	a &lt;&gt; block (with &lt;&gt;)				<a href="motion.html#v_a%3C">v_a&lt;</a>
	i&lt;	inner &lt;&gt; block					<a href="motion.html#v_i%3C">v_i&lt;</a>
	a[	a [] block (with [])				<a href="motion.html#v_a%5B">v_a[</a>
	i[	inner [] block					<a href="motion.html#v_i%5B">v_i[</a>
	...
	a`	a string in backticks (with backticks)		<a href="motion.html#v_a%60">v_a`</a>
	i`	inner string in backticks			<a href="motion.html#v_i%60">v_i`</a></div>
<div class="old-help-para">Additionally the following commands can be used:
	:	start Ex command for highlighted lines (1)	<a href="cmdline.html#v_%3A">v_:</a>
	...
	P	put without overwriting registers		<a href="change.html#v_P">v_P</a>
	...
	^]	find tag					<a href="tagsrch.html#v_CTRL-%5D">v_CTRL-]</a>
	I	block insert					<a href="visual.html#v_b_I">v_b_I</a>
	A	block append					<a href="visual.html#v_b_A">v_b_A</a></div>
<div class="old-help-para">(1): Always whole lines, see <a href="visual.html#%3Avisual_example">:visual_example</a>.
...
(In the &lt;&gt; notation <a href="intro.html#%3C%3E">&lt;&gt;</a>, when typing it you should type it literally; you
need to remove the 'B' flag from <a href="options.html#'cpoptions'">'cpoptions'</a>.)</div>
...
<div class="old-help-para">Another way to operate on the Visual area is using the <a href="pattern.html#%2F%5C%25V">/\%V</a> item in a
...
<div class="old-help-para">Reminder: Use <a href="options.html#'virtualedit'">'virtualedit'</a> to be able to select blocks that start or end
...
deletions.  See <a href="visual.html#v_b_I_example">v_b_I_example</a>.</div>
...
See <a href="visual.html#v_b_%3C_example">v_b_&lt;_example</a>.</div>
...
layout.
See <a href="visual.html#v_b_r_example">v_b_r_example</a>.</div>
...
When the <a href="options.html#'showmode'">'showmode'</a> option is set, "-- SELECT --" is shown in the last line.</div>
<div class="old-help-para">Entering Select mode:
<div class="help-li" style=""> Using the mouse to select an area, and <a href="options.html#'selectmode'">'selectmode'</a> contains "mouse".
  ...
  <a href="options.html#'selectmode'">'selectmode'</a> contains "key".  For example: <code>&lt;S-Left&gt;</code> and <code>&lt;S-End&gt;</code>.  <a href="options.html#'keymodel'">'keymodel'</a>
  must also contain "startsel".
</div><div class="help-li" style=""> Using "v", "V" or <code>CTRL-V</code> command, and <a href="options.html#'selectmode'">'selectmode'</a> contains "cmd".
...
<div class="old-help-para">When mappings and menus are defined with the <a href="map.html#%3Avmap">:vmap</a> or <a href="gui.html#%3Avmenu">:vmenu</a> command they
...
in Visual mode is effective.  If you don't want this use <a href="map.html#%3Axmap">:xmap</a> or <a href="map.html#%3Asmap">:smap</a>.</div>
...
<a href="map.html#%3Asunmap">:sunmap</a>  after <a href="map.html#%3Amap">:map</a> and <a href="map.html#%3Avmap">:vmap</a> to remove it for Select mode.</div>
